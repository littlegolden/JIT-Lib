...
namespace ITD121 {
    ...
    class Program {
        ...
        static void Main(string[] args) {
            ...
            for (int index = 0; index < ringIns.Length; index++) {
                theBeetlesList.Remove(ringIns[index]);
            }
